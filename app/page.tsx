    ...
    >
      ...
      {!showIntro && (
        <>
          ...
          <section className={`flex-1 transition-all duration-200 ${desktopSidebarExpanded ? "md:ml-[300px]" : "md:ml-[64px]"}`}>
            <div
              ref={scrollRef}
              className="h-full overflow-y-auto px-4 pt-4 pb-[220px] max-w-3xl mx-auto w-full"
            >
              <div className="mt-20 mb-3 flex items-center gap-2" />

              {messages.length === 0 && !thinking ? (
                <EmptyChatScreen askExample={(example) => handleAsk(example)} theme={theme} />
              ) : (
                <>
            ...
            <div
              className={`fixed bottom-0 left-0 right-0 ${
                desktopSidebarExpanded ? "md:left-[300px]" : "md:left-[64px]"
              } flex flex-col items-center z-40 pb-3 pt-2 border-t transition-all duration-200 ${
                theme === "light"
                  ? "bg-white border-gray-200"
